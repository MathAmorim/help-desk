...
export default async function TodosOsChamadosPage({
    searchParams,
}: {
    ...
    // Esta página é exclusiva para técnicos e admins
    if (session.user.role !== "SUPORTE" && session.user.role !== "ADMIN") {
        redirect("/dashboard");
    }
    ...
    return (
        <div className="max-w-7xl mx-auto space-y-6">
            ...
            <Filters categoriasDisponiveis={categoriasList} basePath="/dashboard/todos" />
                    ...
                    <div className="overflow-x-auto">
                        <Table>
                            ...
                            <TableBody>
                                {tickets.length === 0 ? (
                                    <TableRow>
                                        <TableCell colSpan={8} className="h-24 justify-center text-center">
