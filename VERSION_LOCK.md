...
- **`next`**: `14.2.35`
  *(Motivo: Versões 16+ impõem regras estritas de módulo ES e Turbopack padrão que quebram a resolução de módulos legados do next-auth v4. Esta sub-versão da família 14 foi adotada por possuir as correções críticas CVE-2025-66478).*
- **`next-auth`**: `4.24.13`
